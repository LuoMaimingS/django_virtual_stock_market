# Generated by Django 2.2.2 on 2019-07-02 06:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profit', models.FloatField(default=0, help_text='profit made till now')),
                ('date_reg', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(blank=True, choices=[('a', 'Activate'), ('f', 'forbidden'), ('i', 'Inactivate')], default='a', help_text='client status', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datetime', models.DateTimeField(default=datetime.datetime(2019, 5, 4, 9, 30))),
