# Generated by Django 2.2.2 on 2019-07-09 23:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cash', models.FloatField(default=10000000000)),
                ('frozen_cash', models.FloatField(default=0)),
                ('flexible_cash', models.FloatField(default=10000000000)),
                ('profit', models.FloatField(default=0)),
                ('date_reg', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(blank=True, choices=[('a', 'Activate'), ('f', 'forbidden'), ('i', 'Inactivate')], default='a', max_length=1)),
                ('strategy', models.CharField(choices=[('n', 'No strategy'), ('r', 'Random strategy')], default='n', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commission_to_cancel', models.UUIDField(verbose_name='委托取消的目标委托本身的uuid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datetime', models.DateTimeField(default=datetime.datetime(2018, 1, 2, 9, 30))),
                ('anchored_datetime', models.DateTimeField(default=datetime.datetime(2018, 1, 2, 9, 30))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entry_belonged', models.IntegerField()),
                ('unique_id', models.UUIDField(default=uuid.uuid4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=20)),
                ('last_price', models.DecimalField(decimal_places=2, max_digits=5, null=True, verbose_name='最新价')),
                ('low', models.DecimalField(decimal_places=2, max_digits=5, null=True, verbose_name='最低价')),
                ('high', models.DecimalField(decimal_places=2, max_digits=5, null=True, verbose_name='最高价')),
                ('limit_up', models.DecimalField(decimal_places=2, max_digits=5, null=True, verbose_name='涨停价')),
                ('limit_down', models.DecimalField(decimal_places=2, max_digits=5, null=True, verbose_name='跌停价')),
                ('volume', models.IntegerField(default=0, verbose_name='交易量')),
        ...
        migrations.CreateModel(
            name='SimStockDailyInfo',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stock_symbol', models.CharField(max_length=12)),
                ('date', models.DateField()),
                ('low', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='最低价')),
                ('high', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='最高价')),
                ('open', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='开盘价')),
                ('close', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='收盘价')),
                ('volume', models.IntegerField(default=0, verbose_name='交易量')),
                ('amount', models.FloatField(default=0, verbose_name='交易额')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_price', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='当前价')),
                ('low', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='最低价')),
                ('high', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='最高价')),
                ('open', models.DecimalField(decimal_places=2, default=0, max_digits=5, verbose_name='开盘价')),
                ('a1', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('a2', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('a3', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('a4', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('a5', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('b1', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('b2', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('b3', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('b4', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('b5', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commission_id', models.UUIDField(default=uuid.uuid4, verbose_name='原本挂单的uuid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation', models.CharField(choices=[('a', 'ASK'), ('b', 'BID'), ('c', 'CANCEL')], default='b', max_length=1, verbose_name='交易一方的成交方向')),
