    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datetime', models.DateTimeField()),
                ('last_price', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='last price of the stock', max_digits=5, null=True, verbose_name='当前价')),
                ('low', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='lowest price of the stock till now today', max_digits=5, null=True, verbose_name='最低价')),
                ('high', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='highest price of the stock till now today', max_digits=5, null=True, verbose_name='最高价')),
                ('open', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=5, null=True, verbose_name='开盘价')),
                ...
                ('volume', models.IntegerField(blank=True, default=0, null=True, verbose_name='交易量')),
                ('amount', models.FloatField(blank=True, default=0, null=True, verbose_name='交易额')),
                ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='market.SimStock')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('high', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='highest price of the stock till now today', max_digits=5, null=True, verbose_name='最高价')),
                ('open', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=5, null=True, verbose_name='开盘价')),
                ('close', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=5, null=True, verbose_name='收盘价')),
                ('volume', models.IntegerField(blank=True, default=0, null=True, verbose_name='交易量')),
                ('amount', models.FloatField(blank=True, default=0, null=True, verbose_name='交易额')),
                ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='market.SimStock')),
            ],
