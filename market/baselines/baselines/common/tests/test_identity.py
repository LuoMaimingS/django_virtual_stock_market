import pytest
from market.baselines.baselines.common.tests.envs.identity_env import DiscreteIdentityEnv, BoxIdentityEnv
from market.baselines.baselines.run import get_learn_function
from market.baselines.baselines.common.tests.util import simple_test
